...
12) Responda de forma sucinta: (1 ponto)
  a) Qual a diferença entre amostragem estratificada e amostragem por conglomerados?
  b) Por que é melhor evitar o gráfico de setores?
  c) Por que não podemos afirmar que dois conjuntos de valores com a mesma mediana são iguais?
  d) O que é um ponto atípico ou outlier?
  e) Causalidade implica em correlação, mas correlação não implica causalidade. Justifique.
...
$Cov(y_1,y_2)=\frac{\sum_{i=1}^n(y_{1i}-\bar y_1)(y_{2i}-\bar y_2)}{n-1}$ \hspace{2cm} $r=\frac{\sum_{i=1}^n (y_{1i}-\bar y_1)(y_{2i}-\bar y_2)}{\sqrt{\sum_{i=1}^n(y1i-\bar y_1)^2} \cdot \sqrt{\sum_{i=1}^n (y_{2i}-\bar y_2)^2}}=\frac{Cov(y_1,y_2)}{\sqrt{Var(y_1)} \cdot \sqrt{Var(y2)}}$
